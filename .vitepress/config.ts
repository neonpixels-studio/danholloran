...
// Post-image variants are committed (generated by `npm run images` or the
// Image Variants GitHub Action), never encoded here, so builds stay fast.
// This only verifies they're present and current: ResponsiveImage.vue points
