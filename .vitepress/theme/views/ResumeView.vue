...
//
// resume.ts drives both this view and the downloadable PDF
// (public/dan_holloran_resume.pdf). After editing resume.ts, re-run the
// skill to regenerate the PDF, then `npm run resume:pdf:sync` to record its
// content hash — the build fails otherwise (see resumePdfManifest.ts).
// ================================================
